...
def privacypolicy(request):
	return render(request,'services/privacypolicy.html')

def termsconditions(request):
	return render(request,'services/termsconditions.html')

def sustainability(request):
	return render(request,'services/sustainability.html')